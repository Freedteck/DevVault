  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        const q = process.env.NEXT_PUBLIC_NEW_QUESTION_TOPIC_ID;
        const a = process.env.NEXT_PUBLIC_NEW_ANSWER_TOPIC_ID;
        const acc = process.env.NEXT_PUBLIC_NEW_ACCEPTANCE_TOPIC_ID;
      ...
      <section className={styles.section}>
        ...
        <div className={styles.grid}>
          {isLoading ? (
            ...
            questions
              .slice(0, 3)
              .map((q: any) => <QuestionCardNew key={q.id} question={q} />)
          ) : (
            <div
              style={{
                gridColumn: "1 / -1",
