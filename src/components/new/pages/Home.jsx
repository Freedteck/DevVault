      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            Get instant solutions, earn crypto for your code, and level up your reputation. 
            The first Web3 developer marketplace powered by Hedera.
          </p>
      ...
      <section className={styles.featureSection}>
        <div className={styles.grid3}>
          <GlassCard className={styles.featureCard} variant="featured">
            <div className={styles.featureIcon} style={{color: 'var(--apex-primary-400)'}}>
              <Code size={32} />
            </div>
            <h3>Code Bounties</h3>
            <p>Post your toughest bugs. Set a price. Get verified solutions from experts.</p>
          </GlassCard>
          
          <GlassCard className={styles.featureCard}>
            <div className={styles.featureIcon} style={{color: 'var(--apex-cyan-400)'}}>
              <Zap size={32} />
            </div>
            <h3>Live Help</h3>
            <p>Real-time pair programming sessions streaming flow payments via x402.</p>
          </GlassCard>

          <GlassCard className={styles.featureCard}>
            <div className={styles.featureIcon} style={{color: 'var(--apex-pink-500)'}}>
              <Trophy size={32} />
            </div>
            <h3>Reputation NFTs</h3>
            <p>Your contributions mint dynamic SBTs. Prove your skills on-chain.</p>
          </GlassCard>
        </div>
      </section>
    </div>
